  ...
  return (
    <div className={styles.contactcontainer}>
      ...
      <div className={styles.contactdetails}>
        <h3 className={styles}>Barbara Darragh</h3>
        <a className={styles.a} href="mailto:barbara.darragh@gmail.com">
          barbara.darragh@gmail.com
        </a>
        <p className={styles.text}>6421948255</p>
        <h3 className={styles}>Gems Agency UK</h3>
        <a className={styles.a} href="mailto:Jayne@gems-agency.co.uk">
          Jayne@gems-agency.co.uk
        </a>
